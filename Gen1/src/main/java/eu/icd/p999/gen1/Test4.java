...
public class Test4 {
	 ...
	 * forall states
	 *   forall symbols
	 *     if (proz1+akt[i] <= akt[i-dist] <= akt[i]+proz2) hit++;
	 *  
	 *   if (hit>threshold) sum+=handel*weight(state)
	 * 
	 * @param steps
	 * @param pos
	 * @return
	...
	/**
	 * s0: y[0]{s, p1, p2}, ... ,y[SYMBOLS-1]{s, p1, p2}
	 * ...
	 * sN: y[0]{s, p1, p2}, ... ,y[SYMBOLS-1]{s, p1, p2}
	 * 
	 * s -> dist in [1, 200] previous day to compare with 
	 * p1 -> proz1 in [-2, 2]
	 * p2 -> proz2 in [-2, 2]
	 *   mit proz1 <= proz2
	 *   
	...
	static void readdata(String ReadData) {
		...
		String line;
		String err;
		double k, k0, bank, res, konto, cost, handel, avg = 0.0, avgk = 0.0, scale=1.0;
